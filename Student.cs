...
namespace lab1
{
    ...
    class Student: Person, IDateAndCopy, IEnumerable
    {
        ...
        public ArrayList Exams //get set для экзаменов
        {
            get
            {
                return _listOfExams;
        ...
        public ArrayList Tests //get set для экзаменов
        {
            get
            {
                return _listOfTests;
        ...
        public string ToShortString() //преобразование в строку со средним баллом без списка тестов и экзаменов
        {
            return "\nДанные студента: " + "\nИмя: " + FirstName + ' ' + LastName + "\nДата рождения: " + Date + "\nФорма обучения: " + _degreeOfEducation + "\nНомер группы: " + _groupNumber + "\nСредний балл: " + GPA;
        }
